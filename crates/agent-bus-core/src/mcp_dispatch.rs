...
impl<'a> McpToolDispatch<'a> {
    ...
    pub fn dispatch_tool(
        ...
        match name {
            ...
            "post_message" => {
                let sender =
                    get_str(args, "sender").ok_or_else(|| anyhow!("sender is required"))?;
                let recipient =
                    get_str(args, "recipient").ok_or_else(|| anyhow!("recipient is required"))?;
                let topic = get_str(args, "topic").ok_or_else(|| anyhow!("topic is required"))?;
                let body = get_str(args, "body").ok_or_else(|| anyhow!("body is required"))?;
            ...
            "ack_message" => {
                let agent = get_str(args, "agent").ok_or_else(|| anyhow!("agent is required"))?;
                let message_id =
                    get_str(args, "message_id").ok_or_else(|| anyhow!("message_id is required"))?;
            ...
            "create_channel" => {
                ...
                let created_by =
                    get_str(args, "created_by").ok_or_else(|| anyhow!("created_by is required"))?;
            ...
            "claim_resource" => {
                let resource =
                    get_str(args, "resource").ok_or_else(|| anyhow!("resource is required"))?;
                let agent = get_str(args, "agent").ok_or_else(|| anyhow!("agent is required"))?;
            ...
            "resolve_claim" => {
                let resource =
                    get_str(args, "resource").ok_or_else(|| anyhow!("resource is required"))?;
                let winner =
                    get_str(args, "winner").ok_or_else(|| anyhow!("winner is required"))?;
